...
export function CancelSubscriptionModal({ open, onClose, currentPeriodEnd }: CancelSubscriptionModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div className="absolute inset-0 bg-black/60 backdrop-blur-sm" onClick={cancelling ? undefined : handleClose} />
      <div className="relative w-full max-w-md rounded-2xl border border-theme-border bg-theme-card p-6 shadow-2xl">
        <button
        ...
        {!done ? (
          <>
            ...
            <h3 className="text-lg font-semibold text-theme-main">Cancel Subscription</h3>
            <div className="mt-4 space-y-3 text-sm text-theme-subtle">
          ...
          <div className="py-4 text-center">
            ...
            <h3 className="text-lg font-semibold text-theme-main">Subscription Cancelled</h3>
