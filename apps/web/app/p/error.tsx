  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-theme-page p-8">
      <div className="max-w-md text-center">
        ...
        <h2 className="text-xl font-bold text-theme-main mb-2">Page unavailable</h2>
        <p className="text-sm text-theme-subtle mb-6">
          This published page encountered an error. Please try again or contact the project owner.
        </p>
        <button
          onClick={reset}
