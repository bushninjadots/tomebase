...
export default function PrivacyPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      <h1 className="text-3xl font-bold text-theme-main mb-8">Privacy Policy</h1>
      <div className="prose prose-gray max-w-none space-y-6 text-theme-subtle text-sm leading-relaxed">
        <p>Last updated: {new Date().toLocaleDateString()}</p>

        <h2 className="text-lg font-semibold text-theme-main mt-8">1. Information We Collect</h2>
        ...
        <h2 className="text-lg font-semibold text-theme-main mt-8">2. How We Use Information</h2>
        ...
        <h2 className="text-lg font-semibold text-theme-main mt-8">3. Data Storage and Security</h2>
        ...
        <h2 className="text-lg font-semibold text-theme-main mt-8">4. Third-Party Services</h2>
        ...
        <h2 className="text-lg font-semibold text-theme-main mt-8">5. Cookies</h2>
        ...
        <h2 className="text-lg font-semibold text-theme-main mt-8">6. Data Retention</h2>
        ...
        <h2 className="text-lg font-semibold text-theme-main mt-8">7. Your Rights</h2>
        ...
        <h2 className="text-lg font-semibold text-theme-main mt-8">8. Changes to Policy</h2>
        <p>We may update this policy. Material changes will be communicated via email or in-app notice.</p>

        <h2 className="text-lg font-semibold text-theme-main mt-8">9. Contact</h2>
