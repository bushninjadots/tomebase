  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-theme-page p-8">
      <div className="max-w-md text-center">
        ...
        <h2 className="text-xl font-bold text-theme-main mb-2">Documentation error</h2>
        <p className="text-sm text-theme-subtle mb-6">
          The documentation viewer hit an unexpected error. The underlying data is unaffected.
        </p>
        <button
          onClick={reset}
